...
+ [ ] 7. Star wars character<br/>_**[7-script.js](7-script.js)**_ contains a JavaScript script that fetches the character `name` from this URL: `https://swapi-api.hbtn.io/api/people/5/?format=json`.
